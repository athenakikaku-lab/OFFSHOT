  ...
  return (
    <div className="min-h-screen bg-purple-50 flex items-center justify-center px-6">
      <div className="w-full max-w-sm bg-white rounded-2xl p-6 border border-purple-200">
        ...
        <h1 className="text-xl font-bold text-gray-900 mb-5 text-center">新規登録</h1>
        <div className="flex flex-col gap-4">
          <input type="text" placeholder="表示名" className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-purple-500"/>
          ...
          <button className="w-full py-3 bg-purple-500 text-white font-bold rounded-xl text-sm hover:bg-purple-700">登録する</button>
        </div>
        <p className="text-center text-xs text-gray-400 mt-4">
          すでにアカウントをお持ちの方は <Link href="/auth/login" className="text-purple-600 font-medium">ログイン</Link>
        </p>
      </div>
    </div>
  )
